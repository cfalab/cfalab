...
contract CFATOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "CFAToken"; 
    string private _symbol = "CFA"; 
    ...
    uint256 public _maxBuyAmount = 500 * 10**4 * 10**9; 
    ...
    IERC20 public usdt = IERC20(0x696C08adfa2ae99d37dC91C8A503a1E5F0A003Ee);
    IWrap public wrap;
    uint256[3] public feeFomo = [4, 5, 6];
    uint256[3] public feeFee = [2, 3, 4];
    uint256[3] public feeLiquidity = [1, 1, 1];
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != fomoReceiver && from != fomoReceiver)
